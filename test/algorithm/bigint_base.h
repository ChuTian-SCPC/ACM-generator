...
struct BigIntBaseTest {
    ...
    int32_t digits;
    std::vector<base_t> v;
    typedef BigIntBaseTest BigInt_t;
    ...
    explicit BigIntBaseTest(int b) { setbase(b); }
    explicit BigIntBaseTest(int b, int d) { base = b, digits = d; }
